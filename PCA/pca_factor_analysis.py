...
fig.tight_layout()
fig.savefig(f"{OUTPUT_DIR}/pca_scree.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(f"{OUTPUT_DIR}/pca_loadings_heatmap.png", dpi=150)
plt.close(fig)
...
ax.set_aspect("equal")
fig.tight_layout()
fig.savefig(f"{OUTPUT_DIR}/pca_biplot.png", dpi=150)
plt.close(fig)
